...
class MySQLDatabase:
    """ A class for interacting with a MySQL database.
        This class facilitates interactions with a MySQL database, allowing to perform various operations such as connecting
    ...
    def __init__(self, config_manager: ConfigurationManager, section):
        """ Initialize the MySQLDatabase instance.
    ...
    def connect(self):
        """ Establish a connection to the MySQL database using the connection string provided during object
        ...
        try:
            ...
            print("Error while connecting to the MySQL database:", e)
    ...
    def drop_all_tables_in_schema(self, schema_name):
        """ Drop all tables in the specified schema in the connected database.
            This method retrieves the names of all tables within the specified schema in the connected MySQL database
        ...
        get_tables_query = f"SHOW TABLES IN {schema_name}"
        try:
