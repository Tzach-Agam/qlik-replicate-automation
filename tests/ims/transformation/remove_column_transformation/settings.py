...
def create_task(ims_test: SimpleNamespace):
    ...
    task_name = f"IMS_2_{ims_test.target_db.config['endpoint']}TRANS_RC"
    ...
    ims_test.table_selection.select_chosen_tables("STRUCT2", "TRANSFORM_TABLE")
    ...
    ims_test.table_settings.remove_column("COL_NUM2")
