...
def create_task(ims_test: SimpleNamespace):
    ...
    ims_test.table_selection.select_chosen_tables("STRUCT2", "STRUCT2__TRANSFORM_TABLE")
    ...
    ims_test.table_settings.add_column_expression("AR_H_USER_COLUMN", "$AR_H_USER")
