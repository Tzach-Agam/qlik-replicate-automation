...
def test_chinese_table(ims_test):
    ...
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DEVPCB\".\"STRUCT2\"  (ROOT_ROOTID, SKEY, CHINESE_TABLE_1_COL1, CHINESE_TABLE_1_COL2)"
    ...
    ims_test.ims_db.cursor.execute(
        f"UPDATE \"DEVPCB\".\"STRUCT2\"  SET CHINESE_TABLE_1_COL1 = X'E6BCA2E6BCA2E6BCA2' WHERE SKEY = 'KEY1'")
    ims_test.ims_db.cursor.execute(
        f"UPDATE \"DEVPCB\".\"STRUCT2\"  SET CHINESE_TABLE_1_COL1 = X'E6BCA2E6BCA2E6BCA2' WHERE SKEY = 'KEY2'")
