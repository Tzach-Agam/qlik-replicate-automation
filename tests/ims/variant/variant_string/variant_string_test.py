...
def test_variant_string(ims_test):
    ...
    ims_test.ims_db.cursor.execute(
        f"UPDATE  \"DVPCB\".\"STRUCT2\" SET VARIANT_SELECTOR = 'XYZ' WHERE SKEY = '00000000000000000001'")
    ims_test.ims_db.cursor.execute(
        f"UPDATE  \"DVPCB\".\"STRUCT2\" SET VARIANT_SELECTOR = 'XYZ', FIELD_B1 = 'UPDA' WHERE SKEY = '00000000000000000002'")
    ims_test.ims_db.cursor.execute(
        f"UPDATE  \"DVPCB\".\"STRUCT2\" SET VARIANT_SELECTOR = 'XYZ', FIELD_B1 = 'UPDA', FIELD_B2 = 12345 WHERE SKEY = '00000000000000000003'")
    ims_test.ims_db.cursor.execute(
    ...
    finalize_test(ims_test, f"IMS_2_{ims_test.target_db.config['endpoint']}_VARIANT_STRING")