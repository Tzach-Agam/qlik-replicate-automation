...
def test_array_in_variant(ims_test):
    ...
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DVPCB\".\"STRUCT2\"  (ROOT_ROOTID, SKEY, COL_CHAR, COL_DEC, DEP_ON_ALPHA, DEP_ON_BETA, DEP_ON_GAMMA)"
        "VALUES ('ROOT000002', 'KEY1', 'TZACHA', 9999, 1, 1, 1)")
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DVPCB\".\"STRUCT2\"  (ROOT_ROOTID, SKEY, COL_CHAR, COL_DEC, VARIANT_SELECTOR, DEP_ON_ALPHA, DEP_ON_BETA, DEP_ON_GAMMA)"
        "VALUES ('ROOT000002', 'KEY2', 'TZACHA', 9999, 'Z', 2, 2, 2)")
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DVPCB\".\"STRUCT2\"  (ROOT_ROOTID, SKEY, COL_CHAR, COL_DEC, VARIANT_SELECTOR, DEP_ON_ALPHA)"
        "VALUES ('ROOT000002', 'KEY3', 'TZACHA', 9999, 'A', 1)")
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DVPCB\".\"STRUCT2\"  (ROOT_ROOTID, SKEY, COL_CHAR, COL_DEC, VARIANT_SELECTOR, DEP_ON_BETA)"
        "VALUES ('ROOT000002', 'KEY4', 'TZACHA', 9999, 'B', 1)")
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DVPCB\".\"STRUCT2\"  (ROOT_ROOTID, SKEY, COL_CHAR, COL_DEC, VARIANT_SELECTOR, DEP_ON_GAMMA)"
    ...
    ims_test.ims_db.cursor.execute(
        f"UPDATE \"DVPCB\".\"STRUCT2\"  SET VARIANT_SELECTOR = 'B', ARRAY_BETA_1_BETA_COL1 = 'UPDAT', ARRAY_BETA_1_BETA_COL2 = 9999 WHERE SKEY = 'KEY9'")
    ims_test.ims_db.cursor.execute(
        f"UPDATE \"DVPCB\".\"STRUCT2\"  SET VARIANT_SELECTOR = 'C', ARRAY_GAMMA_1_GAMMA_COL1 = 'UPDAT', ARRAY_GAMMA_1_GAMMA_COL2 = 9999 WHERE SKEY = 'KEY15'")
    ims_test.ims_db.cursor.execute(
        f"UPDATE \"DVPCB\".\"STRUCT2\"  SET VARIANT_SELECTOR = 'A', ARRAY_ALPHA_1_ALPHA_COL1 = 'UPDAT', ARRAY_ALPHA_1_ALPHA_COL2 = 9999 WHERE SKEY = 'KEY21'")

    ims_test.ims_db.cursor.execute(f"DELETE FROM \"DVPCB\".\"STRUCT2\"  WHERE SKEY = 'KEY11'")
    ims_test.ims_db.cursor.execute(f"DELETE FROM \"DVPCB\".\"STRUCT2\"  WHERE SKEY = 'KEY17'")
    ims_test.ims_db.cursor.execute(f"DELETE FROM \"DVPCB\".\"STRUCT2\"  WHERE SKEY = 'KEY23'")
    ims_test.ims_db.connection.commit()

    ims_test.ims_db.sync_command()

    ims_test.monitor_page.wait_for_cdc()
    ims_test.monitor_page.insert_check('23', '14', '14', '14')
    ims_test.monitor_page.update_check('3', '0', '0', '0')
    ims_test.monitor_page.delete_check('3', '4', '4', '4')
