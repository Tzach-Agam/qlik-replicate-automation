...
def create_task(ims_test: SimpleNamespace):
    ...
    ims_test.table_selection.select_chosen_tables("STRUCT2", "STRUCT2__ARRAY_ALPHA", "STRUCT2__ARRAY_ALPHA__ARRAY_BETA", "STRUCT2__ARRAY_ALPHA__ARRAY_BETA__ARRAY_GAMMA")
