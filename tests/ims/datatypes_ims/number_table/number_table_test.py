...
def test_number_datatype(ims_test):
    ...
    ims_test.ims_db.cursor.execute(
        f"UPDATE  \"DEVPCB\".\"ALLTYPES\" SET NUMBER_TABLE_1_USHORT = 20, NUMBER_TABLE_1_ULONG = 2000, NUMBER_TABLE_1_UINT_COL = 20000 , NUMBER_TABLE_1_SHORT_COL = 22, NUMBER_TABLE_1_LONG_COL = 20000 , NUMBER_TABLE_1_INT_COL = 200000,  NUMBER_TABLE_1_UNSIGNED_DEC = 33.33, NUMBER_TABLE_1_ZONE_DEC = 22.22, NUMBER_TABLE_1_PACKED_DEC = 2.22 WHERE ID = 12")
    ims_test.ims_db.cursor.execute(
