...
def test_char_datatype(ims_test):
    ...
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DEVPCB\".\"ALLTYPES\" (ROOT_ROOTID, ID) VALUES ('ROOT000000', 24)")
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DEVPCB\".\"ALLTYPES\" (ROOT_ROOTID, ID, CHAR_TABLE_1_CHAR_COL1, CHAR_TABLE_1_CHAR_COL2) VALUES "
    ...
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DEVPCB\".\"ALLTYPES\" (ROOT_ROOTID, ID) VALUES ('ROOT000000', 32)")
    ims_test.ims_db.cursor.execute(
        f"UPDATE  \"DEVPCB\".\"ALLTYPES\" SET CHAR_TABLE_1_CHAR_COL1 = 'updated_value', CHAR_TABLE_1_CHAR_COL2 = 'updated_value' WHERE ID = 3")
    ims_test.ims_db.cursor.execute(
        f"UPDATE  \"DEVPCB\".\"ALLTYPES\" SET CHAR_TABLE_1_CHAR_COL1 = 'updated_value2', CHAR_TABLE_1_CHAR_COL2 = 'updated_value2' WHERE ID = 5")
    ims_test.ims_db.cursor.execute(
        f"UPDATE  \"DEVPCB\".\"ALLTYPES\" SET CHAR_TABLE_1_CHAR_COL1 = 'updated_value', CHAR_TABLE_1_CHAR_COL2 = 'updated_value' WHERE ID = 12")
    ims_test.ims_db.cursor.execute(
        f"UPDATE  \"DEVPCB\".\"ALLTYPES\" SET CHAR_TABLE_1_CHAR_COL1 = 'updated_value2', CHAR_TABLE_1_CHAR_COL2 = 'updated_value2' WHERE ID = 13")
    ims_test.ims_db.cursor.execute(
        f"DELETE FROM \"DEVPCB\".\"ALLTYPES\" WHERE ID = 14")
    ims_test.ims_db.cursor.execute(
        f"DELETE FROM \"DEVPCB\".\"ALLTYPES\" WHERE ID = 15")
    ims_test.ims_db.connection.commit()

    ims_test.ims_db.sync_command()

    ims_test.monitor_page.wait_for_cdc()
    ims_test.monitor_page.insert_check('16', '14')
