...
def test_binary_datatype(ims_test):
    ...
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DVPCB\".\"ALLTYPES\" (ROOT_ROOTID, ID, BINARY_TABLE_1_BINARY_COL1, BINARY_TABLE_1_BINARY_COL2, BINARY_TABLE_1_BYTE_COL1, BINARY_TABLE_1_BYTE_COL2)"
    ...
    ims_test.ims_db.cursor.execute(
        f"UPDATE  \"DVPCB\".\"ALLTYPES\" SET BINARY_TABLE_1_BINARY_COL1 = X'CB34567890ABCDEF1234567890ABCDEF1234567890ABCDEF1234567890CB' WHERE ID = 6")
    ims_test.ims_db.cursor.execute(
        f"UPDATE  \"DVPCB\".\"ALLTYPES\" SET BINARY_TABLE_1_BINARY_COL2 = X'CB34567890ABCDEF1234567890ABCDEF1234567890ABCDEF1234567890CB' WHERE ID = 5")
    ims_test.ims_db.cursor.execute(
