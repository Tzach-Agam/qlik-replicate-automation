...
def test_struct_depon_array_parent(ims_test):
    """Test when the depends on of an array is in a struct that is the parent of the array struct"""
    create_task(ims_test)
    ims_test.ims_db.cursor.execute("DELETE FROM \"DEVPCB\".\"STRUCT4\"")
    ims_test.ims_db.cursor.execute(f"INSERT INTO \"DEVPCB\".\"STRUCT4\" (ROOT_ROOTID, SKEY, DEP_ON_FIELD,"
    ...
    ims_test.ims_db.cursor.execute(f"INSERT INTO \"DEVPCB\".\"STRUCT4\" (ROOT_ROOTID, SKEY)" 
    ...
    ims_test.ims_db.cursor.execute(
        f"UPDATE \"DEVPCB\".\"STRUCT4\" SET DEP_ON_FIELD = 2, ARRAY_DATE_2_ARRAY_DAY = 26, ARRAY_DATE_2_ARRAY_MONTH = 'August Update', ARRAY_DATE_2_ARRAY_YEAR = 1999 WHERE SKEY = 'KEY4'")
    ims_test.ims_db.cursor.execute(
        f"UPDATE \"DEVPCB\".\"STRUCT4\" SET DEP_ON_FIELD = 2, ARRAY_DATE_1_ARRAY_MONTH = 'August Update', ARRAY_DATE_2_ARRAY_YEAR = 1999 WHERE SKEY = 'KEY8'")
    ims_test.ims_db.cursor.execute(
        f"UPDATE \"DEVPCB\".\"STRUCT4\" SET DEP_ON_FIELD = 2, ARRAY_DATE_1_ARRAY_MONTH = 'May Update', ARRAY_DATE_2_ARRAY_DAY = 26, ARRAY_DATE_2_ARRAY_MONTH = 'August Update', ARRAY_DATE_2_ARRAY_YEAR = 1999 WHERE SKEY = 'KEY1'")
    ...
    ims_test.target_db.export_schema_data_to_csv(ims_test.target_schema,
                                                 ims_test.good_files_dir + f"\\IMS_2_{ims_test.target_db.config['endpoint']}_STRUCT_DEPON_ARRAY_PARENT.csv")
    compare_files(ims_test.good_files_dir + f"\\IMS_2_{ims_test.target_db.config['endpoint']}_STRUCT_DEPON_ARRAY_PARENT.good",
                  ims_test.good_files_dir + f"\\IMS_2_{ims_test.target_db.config['endpoint']}_STRUCT_DEPON_ARRAY_PARENT.csv")
