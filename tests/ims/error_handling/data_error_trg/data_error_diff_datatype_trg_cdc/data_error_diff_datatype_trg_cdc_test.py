...
def test_data_error_trg_cdc(ims_test):
    ...
    if ims_test.target_type == "oracle":
        ims_test.target_db.execute_query(f"CREATE TABLE \"{ims_test.target_schema}\".STRUCT2__BASIC_TABLE (ROOTID NVARCHAR2(20), SKEY NVARCHAR2(40), BASIC_TABLE_ROWNUM NUMBER, COL5_CHAR NVARCHAR2(50), COL4_DECIMAL NUMBER, COL3_CHAR NVARCHAR2(50), COL2_DECIMAL NUMBER, COL1_CHAR NUMBER, PRIMARY KEY (ROOTID, SKEY, BASIC_TABLE_ROWNUM))")
    if ims_test.target_type == "sqlserver":
        ims_test.target_db.execute_query(f"CREATE TABLE \"{ims_test.target_schema}\".STRUCT2__BASIC_TABLE (ROOTID NVARCHAR(20), SKEY NVARCHAR(40), BASIC_TABLE_ROWNUM NUMERIC, COL5_CHAR NVARCHAR(50), COL4_DECIMAL NUMERIC, COL3_CHAR NVARCHAR(50), COL2_DECIMAL NUMERIC, COL1_CHAR NUMERIC, PRIMARY KEY (ROOTID, SKEY, BASIC_TABLE_ROWNUM))")
    ...
    finalize_test(ims_test, f"IMS_2_{ims_test.target_db.config['endpoint']}DATA_ERROR_CDC")