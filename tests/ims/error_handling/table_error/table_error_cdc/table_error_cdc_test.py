...
def test_table_error_cdc(ims_test):
    ...
    ims_test.target_db.execute_query(f"DROP TABLE \"{ims_test.target_schema}\".STRUCT3__ARRAY_BASE__ARRAY_1__ARRAY_2")
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DVPCB\".\"STRUCT3\" (ROOT_ROOTID, SKEY, ARRAY_BASE_1_CHAR_COL_BASE, ARRAY_BASE_1_ARRAY_1_1_CHAR_COL_1, ARRAY_BASE_1_ARRAY_1_1_ARRAY_2_1_CHAR_COL_2, ARRAY_BASE_1_ARRAY_1_1_ARRAY_2_1_DECIMAL_COL_2, ARRAY_BASE_1_ARRAY_1_1_ARRAY_2_1_ARRAY_3_1_CHAR_COL_3, ARRAY_BASE_1_ARRAY_1_1_ARRAY_2_1_ARRAY_3_1_ARRAY_4_1_CHAR_COL_4, ARRAY_BASE_1_ARRAY_1_1_ARRAY_2_1_ARRAY_3_1_ARRAY_4_1_ARRAY_5_1_CHAR_COL_5)"
    ...
    ims_test.monitor_page.wait_for_message_in_ui("Table 'IMSDEV'.'STRUCT3__ARRAY_BASE__ARRAY_1__ARRAY_2' (subtask 0 thread 1) is suspended")
    ...
    log_finder(ims_test.task_logs_dir + f"\\reptask_{ims_test.task_name}.log",
               " ]W:  Table 'IMSDEV'.'STRUCT3__ARRAY_BASE__ARRAY_1__ARRAY_2' (subtask 0 thread 1) is suspended",
               ims_test.good_files_dir + f"\\IMS_2_{ims_test.target_db.config['endpoint']}TABLE_ERROR_CDC.csv")
    finalize_test(ims_test, f"IMS_2_{ims_test.target_db.config['endpoint']}TABLE_ERROR_CDC")