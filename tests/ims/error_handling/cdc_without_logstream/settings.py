...
def create_endpoints(ims_test: SimpleNamespace):
    ...
    ims_test.manage_endpoints.create_custom_ims_source_endpoint(
        ims_test.ims_source_name, 'IMS Source Endpoint', dbd_xml=ims_test.dbd_file, logstream_name=" ")
...
def create_task(ims_test: SimpleNamespace):
    ...
    task_name = f"IMS2{ims_test.target_db.config['endpoint']}NO_LOGS"
    ...
    ims_test.table_selection.select_chosen_tables("STRUCT2", "STRUCT2__BASIC_TABLE")
