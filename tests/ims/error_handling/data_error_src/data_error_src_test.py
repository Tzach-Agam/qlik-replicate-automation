...
def test_data_error_src(ims_test):
    ...
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DVPCB\".\"STRUCT2\" (ROOT_ROOTID, SKEY, BASIC_TABLE_1_COL1_CHAR, BASIC_TABLE_1_COL2_DECIMAL, BASIC_TABLE_1_COL3_CHAR, BASIC_TABLE_1_COL5_CHAR)"
        "VALUES('ROOT000002', 'KEY7', 'Full_Load', 2222, 'Full_Load', 'Full_Load')")
    ims_test.ims_db.cursor.execute(
        f"INSERT INTO \"DVPCB\".\"STRUCT2\" (ROOT_ROOTID, SKEY, BASIC_TABLE_1_COL1_CHAR, BASIC_TABLE_1_COL3_CHAR, BASIC_TABLE_1_COL5_CHAR)"
    ...
    log_finder(ims_test.task_logs_dir + f"\\reptask_{ims_test.task_name}.log",
               ...
               ims_test.good_files_dir + f"\\IMS_2_{ims_test.target_db.config['endpoint']}DATA_ERROR_SRC.csv")
    finalize_test(ims_test, f"IMS_2_{ims_test.target_db.config['endpoint']}DATA_ERROR_SRC")